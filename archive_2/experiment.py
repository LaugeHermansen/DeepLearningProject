...
base_params = dict(
    ...
    # own params
    data_dir = 'dataset', # used only to preprocess, has to be parent to all other
    num_workers = 4,
    fp16 = True
)
...
def main(model_path, params, exp_name, global_seed):
...
if __name__ == '__main__':
    ...
    global_seed = parser.parse_args().seed
    ...
    main(model_path, params, exp_name, global_seed)
